...
- **左键：** 打开或关闭额度卡片。
- **右键：** 立即刷新、打开 Codex 用量页、选择 1/5/15 分钟刷新、配置低额度提醒、选择主题、切换开机启动、查看新版本或退出。
- **托盘数字：** 周剩余百分比四舍五入到整数。
...
- `settings.json`：刷新间隔、界面语言、主题、提醒阈值、首次引导、最近一次成功更新检查和提醒去重状态。
...
在 Windows 11 24H2 x64、v0.2.2 Release 版上的实测：
